/************************************************************************************************
 * Objetivo: Model reponsavel pelo CRUD de dados referente à tabela de jogo_plataforma
 *          no Banco de Dados
 * Data: 13/02/25
  ...
  try {
      let sql = `select tbl_plataforma.* from tbl_jogo 
                          ...
                          inner join tbl_plataforma
                            on tbl_plataforma.id_plataforma = tbl_jogo_plataforma.id_plataforma
...
const selectJogoByIdPlataforma = async function(id_plataforma){
  try {
      let sql = `select tbl_jogo.* from tbl_jogo 
                          ...
                          inner join tbl_plataforma
                            on tbl_plataforma.id_plataforma = tbl_jogo_plataforma.id_plataforma
                      where tbl_plataforma.id_plataforma = ${id_plataforma}`
